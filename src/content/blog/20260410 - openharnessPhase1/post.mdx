...
> **什么是 Harness？** 如果你看过 OpenAI 和 Anthropic 最近关于 Agent 的论文，应该知道一个共识：**模型负责智能，Harness 负责一切其他**。Harness 是包裹在 LLM 外面的完整基础设施——工具、记忆、权限、上下文、多 Agent 协作。用项目作者的话说：_"The model is the agent. The code is the harness."_
