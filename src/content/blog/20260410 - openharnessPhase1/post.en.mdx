...
Claude Code is a closed-source product written in TypeScript, and the code is obfuscated on top of that. As a developer who wants to grow into full-stack AI Agent work, I know perfectly well that just being able to _use_ it isn't enough — I need to understand how a production-grade Agent is actually built.
...
- **Execution layer**: engine, tools, permissions, hooks — _how the Agent runs_
- **Knowledge layer**: prompts, skills, memory — _what the Agent knows_
- **Extension layer**: mcp, plugins, coordinator, tasks, commands — _how the Agent connects to the outside world_
