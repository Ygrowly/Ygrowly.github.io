...
My last post, [_A 1-Hour-19-Minute Agent Engineer Mock Interview_](/en/blog/20260512---agentmockinterview/post), was also a debrief from **my seat as the interviewer** — except that one had two interviewers, whereas this time it was just me grilling H one-on-one.
...
💡 **The standard answer (I wasn't precise enough live; filling it in here based on [Anthropic's official blog _Lessons from building Claude Code: Prompt caching is everything_](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything))**:
